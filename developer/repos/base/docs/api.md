...
- if queryField is defined, then:
    ...
    - the query field also takes *filter*, *sortDirection*, *limit* and *nextToken*.
...
## Mocking
The client app should arrange for mocking by using the type definitions.
